...
class MyApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.ui = Ui_MainWindow()  # Fixed this line
    ...
    def call_api_gen_keys(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)  # Fixed this line
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data['is_verified']:
                    ...
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Warning)  # Changed to Warning for failure
